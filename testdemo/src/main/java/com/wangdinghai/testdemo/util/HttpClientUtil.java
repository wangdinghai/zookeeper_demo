package com.wangdinghai.testdemo.util;
...
public class HttpClientUtil {
    ...
    public static void createOrder(int id){
        ...
        String post = doPost("http://localhost:8080/saveOrder", map, Charset.forName("UTF-8"));
        System.out.println("post调用成功，返回数据是：" + post);
    }

    public static void main(String[] args) {
        Map<String, String> map = new HashMap<String, String>();
        String get = doGet("http://localhost:8080/ok", map);
